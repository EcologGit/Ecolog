...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Admarea',
            fields=[
                ('admareaid', models.IntegerField(db_column='admareaID', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Difictulites',
            fields=[
                ('diffictulityid', models.IntegerField(db_column='diffictulityID', primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=64)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Districts',
            fields=[
                ('districtid', models.IntegerField(db_column='districtID', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reportid', models.IntegerField(blank=True, db_column='ReportID', null=True)),
            ],
            options={
                'db_table': 'Events',
                'managed': False,
        ...
        migrations.CreateModel(
            name='GarbagePoints',
            fields=[
                ('pointid', models.IntegerField(db_column='PointID', primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=64)),
        ...
        migrations.CreateModel(
            name='Rates',
            fields=[
                ('rateid', models.IntegerField(db_column='RateID', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.TextField(blank=True, null=True)),
                ('time', models.DateTimeField()),
                ('statusid_r', models.IntegerField(db_column='StatusID_R')),
                ('eventid', models.IntegerField(blank=True, db_column='EventID', null=True)),
        ...
        migrations.CreateModel(
            name='Results',
            fields=[
                ('resultid', models.IntegerField(db_column='ResultID', primary_key=True, serialize=False)),
                ('description', models.CharField(max_length=1)),
                ('time', models.DateTimeField()),
